...
public class UsuarioForm extends Form {
	...
	public UsuarioForm() {
		...
		//mainLayout.addComponent(label_1, "top:60.0px;left:50.0px;");
		...
		//mainLayout.addComponent(txtNombre, "top:100.0px;left:50.0px;");
		...
		//mainLayout.addComponent(txtClave, "top:180.0px;left:403.0px;");
		...
		//mainLayout.addComponent(btnInsertar, "top:300.0px;left:160.0px;");
		
		// btnReset
		btnReset = new Button();
		btnReset.setCaption("Limpiar campos");
		btnReset.setImmediate(false);
		btnReset.setWidth("-1px");
		btnReset.setHeight("-1px");
		//mainLayout.addComponent(btnReset, "top:300.0px;left:340.0px;");
